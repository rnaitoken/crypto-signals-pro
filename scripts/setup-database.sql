-- ================================================================
-- CryptoSignalsPro - Database Setup Script
...
create table if not exists public.signals (
  ...
  -- Signal metadata
  timeframe text default '4h',        -- 1h, 4h, 1d
  strategy text,                        -- e.g. 'breakout', 'scalp'
  confidence integer default 70,     -- 0-100
  analysis text,                      -- AI analysis notes
...
-- ================================================================
-- TABLE 4: user_signals (which users received which signals)
-- ================================================================
...
-- ================================================================
-- TABLE 5: commissions (performance fees)
-- ================================================================
create table if not exists public.commissions (
  ...
  commission_rate numeric(5,2) not null,  -- e.g. 30.00 for 30%
  commission_amount numeric(10,2) not null,
  
  threshold numeric(10,2) default 5.00,   -- min profit to charge (%)
...
-- Signals: everyone can read signals, only service can insert
create policy "Everyone can read signals" on public.signals for select using (true);
create policy "Service can insert signals" on public.signals for insert with check (true);

-- User signals: users can read their own
...
-- Activity: users can read their own
